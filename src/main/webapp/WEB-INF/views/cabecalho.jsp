	...
	<div class="clearfix container">
		...
		<div id="header-content">
			<ul class="menu-dropdown">
				<li><a style="color:white"><fmt:message key="menu.dropdown" /></a>
					<ul>
						<security:authorize access="hasRole('ROLE_ADMIN')">
							...
							<li><a href="${s:mvcUrl('PSC#listarPedidos').build() }"
								rel="nofollow"><fmt:message key="menu.pedido_produtos" /></a></li>
							<li><a href="${s:mvcUrl('UC#listarUsuarios').build() }"
								rel="nofollow"><fmt:message key="menu.lista_usuarios" /></a></li>
						</security:authorize>
						<li><a href="${s:mvcUrl('CCC#itens').build() }"
							rel="nofollow"> <s:message code="menu.carrinho"
